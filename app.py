...
class Login:
    ...
    def load_gui(self):
        ...
        self.label1=Label(self.root, text="Tinder",fg="white",bg="blue")
        self.label1.configure(font=("Times",30,"bold"))
        self.label1.pack(pady=(10,10))

        self.label2=Label(self.root,text="Email:",fg="white",bg="blue")
        self.label2.configure(font=("Times",20,"italic"))
        self.label2.pack(pady=(15,5))

        self.email=Entry(self.root)
        self.email.pack(pady=(0,10),ipadx=30,ipady=5)

        self.label3=Label(self.root,text="Password:",fg="white",bg="blue")
        self.label3.configure(font=("Times",20,"italic"))
        self.label3.pack(pady=(15,5))
        ...
        self.login.pack(pady=(15,10),ipadx=70,ipady=4)

        self.label4 = Label(self.root, text="Not a member? Sign Up", fg="white", bg="blue")
        self.label4.configure(font=("Times", 13, "italic"))
        self.label4.pack(pady=(70,5))
    ...
    def register_gui(self):
        self.clear()
        self.label0 = Label(self.root, text="Tinder", fg="white", bg="blue")
        self.label0.configure(font=("Times", 30, "bold"))
        self.label0.pack(pady=(5, 5))

        self.label1 = Label(self.root, text="Name", fg="white", bg="blue")
        ...
        self.register.pack(pady=(15, 10), ipadx=70, ipady=4)

        self.label4 = Label(self.root, text="Already a member? Login", fg="white", bg="blue")
        self.label4.configure(font=("Times", 13, "italic"))
    ...
    def main_window(self,data,mode=1,index=None,num=None):
        ...
        self.label1=Label(self.root,text="Name: "+data[1],fg="white",bg="blue")
        self.label1.configure(font=("Times",15,"bold"))
        self.label1.pack(pady=(10,10))

        if len(data[7])!=0:
            self.label2 = Label(self.root, text="From: " + data[7], fg="white", bg="blue")
            self.label2.configure(font=("Times", 15, "bold"))
            self.label2.pack(pady=(10, 10))

        if len(data[6])!=0:
            self.label3 = Label(self.root, text="Not interested in : " + data[6], fg="white", bg="blue")
            self.label3.configure(font=("Times", 15, "bold"))
            self.label3.pack(pady=(10, 10))

        if len(data[4])!=0:
            self.label4 = Label(self.root, text="About me: " + data[4], fg="white", bg="blue")
    ...
    def edit_profile(self):
        ...
        self.label0 = Label(self.root, text="Edit Profile", fg="white", bg="blue")
        self.label0.configure(font=("Times", 30, "bold"))
        self.label0.pack(pady=(10, 10))

        self.label1 = Label(self.root, text="Bio:", fg="white", bg="blue")
        ...
        self.label2 = Label(self.root, text="Age:", fg="white", bg="blue")
        ...
        self.label3 = Label(self.root, text="Gender:", fg="white", bg="blue")
        ...
        self.label4 = Label(self.root, text="City:", fg="white", bg="blue")
        ...
        self.edit.pack(pady=(5, 10), ipadx=60, ipady=4)
    ...
    def reg_submit(self):
        ...
        if response==1:
            shutil.copyfile(self.filename['text'],"C:/Users/Susmita/PycharmProjects/finder/images/"+filename)
